...
description: Create and publish your own registry of project presets
---

This is the **preset** registry — publish and share whole project presets that
`create` consumes. For ready-made workspace *packages* added with `cts add`, see
